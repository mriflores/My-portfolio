(function ($) {
  ...
  // Portfolio filtering without Shuffle layout
  ...
  jQuery('input[name="shuffle-filter"]').on("change", function (evt) {
    ...
    items.forEach(function(item) {
      ...
      if (filterValue === 'all') {
        ...
        setTimeout(function() {
          item.classList.add('shuffle-item--visible');
          item.classList.remove('shuffle-item--hidden');
        }, 0);
      } else {
        if (groups && groups.includes(filterValue)) {
          item.style.display = 'block';
          setTimeout(function() {
            item.classList.add('shuffle-item--visible');
            item.classList.remove('shuffle-item--hidden');
          ...
          item.classList.add('shuffle-item--hidden');
          item.classList.remove('shuffle-item--visible');
          setTimeout(function() {
